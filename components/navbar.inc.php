...
<nav class="navbar navbar-expand-lg text-center mx-auto">
    <div class="container flex-column mx-auto text-center">
        ...
        <!-- Brand -->
        <a class="navbar-brand row mx-auto" href="<?php echo get_home_url(); ?>">
            <img src="<?php echo get_template_directory_uri(); ?>/img/AyakaLogo_nobg.png" class="img-fluid mx-auto" alt="Ayaka logo">
        </a>

        <!-- Collapse -->
        <button class="navbar-toggler row mx-auto" type="button" data-toggle="collapse" data-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
