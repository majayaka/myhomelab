...
<footer class="bd-footer text-center text-lg-start my-2">
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        <div>
            <a href="https://www.facebook.com/yumotoayaka/" class="me-4 link-secondary">
                <i class='bx bxl-facebook-circle'></i>
            </a>
            <a href="https://github.com/majayaka" class="me-4 link-secondary">
                <i class='bx bxl-github'></i>
            </a>
            <a href="https://www.instagram.com/yumotoayaka.fr/" class="me-4 link-secondary">
                <i class='bx bxl-instagram-alt'></i>
            </a>
            <a href="https://twitter.com/yumotoayaka_fr" class="me-4 link-secondary">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 mx-auto align-items-center mt-5 footer-items">
                    ...
                    <p>
                        <a href="<?php echo home_url(); ?>/blog" class="text-reset">BLOG</a>
                    </p>
                    <p>
